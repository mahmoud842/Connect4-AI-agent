  ...
  children: [
    {
      ...
      edgeLabel: 'L',
      children: [
        { value: 3, player: 'LEAF', depth: 2, move: 0, edgeLabel: 'L', children: [] },
        { value: 5, player: 'LEAF', depth: 2, move: 1, edgeLabel: 'R', children: [] }
      ]
    },
    {
      value: 9,
      ...
      edgeLabel: 'R',
      children: [
        { value: 2, player: 'LEAF', depth: 2, move: 0, edgeLabel: 'L', children: [] },
        { value: 9, player: 'LEAF', depth: 2, move: 1, edgeLabel: 'R', children: [] }
      ]
    }
  ]
};
  ...
  children: [
    {
      ...
      probability: 0.5,
      children: [
        { value: 3.2, player: 'LEAF', depth: 2, move: 0, probability: 0.7, children: [] },
        { value: 5.1, player: 'LEAF', depth: 2, move: 1, probability: 0.3, children: [] }
      ]
    },
    {
      value: 4.8,
      ...
      probability: 0.3,
      children: [
        { value: 4.8, player: 'LEAF', depth: 2, move: 0, probability: 0.5, children: [] },
        { value: 5.5, player: 'LEAF', depth: 2, move: 1, probability: 0.5, children: [] }
      ]
    }
  ]
};
      ...
      <div className="tree-node-container">
        ...
        >
          ...
          <div className="node-value" style={{ color: style.color }}>
            {typeof node.value === 'number' ? node.value.toFixed(node.player === 'LEAF' ? 0 : 1) : node.value}
          </div>
          {isExpectiminimax && node.probability && (
            <div className="node-prob" style={{ color: style.color, opacity: 0.8 }}>
              p={node.probability}
            </div>
          )}
        </div>
    ...
    <div className="tree-visualization-container">
      ...
      <div className="tree-content">
        <div className="tree-wrapper">
          <TreeNode node={treeData} isExpectiminimax={isExpectiminimax} isRoot={true} />
        </div>
      </div>
      ...
      <div className="tree-info">
        <div className="info-card">
          ...
          <ul>
            <li><strong>⚪ MAX nodes (white):</strong> AI tries to maximize the score</li>
            <li><strong>⚫ MIN nodes (black):</strong> Opponent tries to minimize the score</li>
            {isExpectiminimax && (
              <li><strong>🟠 CHANCE nodes (orange):</strong> Probabilistic outcomes</li>
            )}
            <li><strong>🟢 LEAF nodes (green):</strong> Terminal states with evaluation scores</li>
            <li><strong>Values:</strong> Evaluation scores at each state</li>
            {!isExpectiminimax && <li><strong>L/R labels:</strong> Left and Right branches</li>}
          </ul>
        </div>
      </div>
    </div>
